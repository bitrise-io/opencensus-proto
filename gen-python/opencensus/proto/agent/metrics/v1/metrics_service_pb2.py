...
from opencensus.proto.metrics.v1 import \
...
_EXPORTMETRICSSERVICEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='node',
            full_name=
            'opencensus.proto.agent.metrics.v1.ExportMetricsServiceRequest.node',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='metrics',
            full_name=
            'opencensus.proto.agent.metrics.v1.ExportMetricsServiceRequest.metrics',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='resource',
            full_name=
            'opencensus.proto.agent.metrics.v1.ExportMetricsServiceRequest.resource',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_EXPORTMETRICSSERVICEREQUEST.fields_by_name[
    'node'].message_type = opencensus_dot_proto_dot_agent_dot_common_dot_v1_dot_common__pb2._NODE
_EXPORTMETRICSSERVICEREQUEST.fields_by_name[
    'metrics'].message_type = opencensus_dot_proto_dot_metrics_dot_v1_dot_metrics__pb2._METRIC
_EXPORTMETRICSSERVICEREQUEST.fields_by_name[
...
DESCRIPTOR.message_types_by_name[
    'ExportMetricsServiceResponse'] = _EXPORTMETRICSSERVICERESPONSE
