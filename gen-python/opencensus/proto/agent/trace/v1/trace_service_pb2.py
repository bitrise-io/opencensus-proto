...
from opencensus.proto.agent.common.v1 import \
    common_pb2 as \
    opencensus_dot_proto_dot_agent_dot_common_dot_v1_dot_common__pb2
from opencensus.proto.resource.v1 import \
    resource_pb2 as opencensus_dot_proto_dot_resource_dot_v1_dot_resource__pb2
from opencensus.proto.trace.v1 import \
    trace_config_pb2 as \
    opencensus_dot_proto_dot_trace_dot_v1_dot_trace__config__pb2
from opencensus.proto.trace.v1 import \
    trace_pb2 as opencensus_dot_proto_dot_trace_dot_v1_dot_trace__pb2
...
_CURRENTLIBRARYCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='node',
            full_name=
            'opencensus.proto.agent.trace.v1.CurrentLibraryConfig.node',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='config',
            full_name=
            'opencensus.proto.agent.trace.v1.CurrentLibraryConfig.config',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_UPDATEDLIBRARYCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='node',
            full_name=
            'opencensus.proto.agent.trace.v1.UpdatedLibraryConfig.node',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='config',
            full_name=
            'opencensus.proto.agent.trace.v1.UpdatedLibraryConfig.config',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_EXPORTTRACESERVICEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='node',
            full_name=
            'opencensus.proto.agent.trace.v1.ExportTraceServiceRequest.node',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='spans',
            full_name=
            'opencensus.proto.agent.trace.v1.ExportTraceServiceRequest.spans',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='resource',
            full_name=
            'opencensus.proto.agent.trace.v1.ExportTraceServiceRequest.resource',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_CURRENTLIBRARYCONFIG.fields_by_name[
    'node'].message_type = opencensus_dot_proto_dot_agent_dot_common_dot_v1_dot_common__pb2._NODE
_CURRENTLIBRARYCONFIG.fields_by_name[
    'config'].message_type = opencensus_dot_proto_dot_trace_dot_v1_dot_trace__config__pb2._TRACECONFIG
_UPDATEDLIBRARYCONFIG.fields_by_name[
    'node'].message_type = opencensus_dot_proto_dot_agent_dot_common_dot_v1_dot_common__pb2._NODE
_UPDATEDLIBRARYCONFIG.fields_by_name[
    'config'].message_type = opencensus_dot_proto_dot_trace_dot_v1_dot_trace__config__pb2._TRACECONFIG
_EXPORTTRACESERVICEREQUEST.fields_by_name[
    'node'].message_type = opencensus_dot_proto_dot_agent_dot_common_dot_v1_dot_common__pb2._NODE
_EXPORTTRACESERVICEREQUEST.fields_by_name[
    'spans'].message_type = opencensus_dot_proto_dot_trace_dot_v1_dot_trace__pb2._SPAN
_EXPORTTRACESERVICEREQUEST.fields_by_name[
    'resource'].message_type = opencensus_dot_proto_dot_resource_dot_v1_dot_resource__pb2._RESOURCE
DESCRIPTOR.message_types_by_name[
    'CurrentLibraryConfig'] = _CURRENTLIBRARYCONFIG
DESCRIPTOR.message_types_by_name[
    'UpdatedLibraryConfig'] = _UPDATEDLIBRARYCONFIG
DESCRIPTOR.message_types_by_name[
    'ExportTraceServiceRequest'] = _EXPORTTRACESERVICEREQUEST
DESCRIPTOR.message_types_by_name[
    'ExportTraceServiceResponse'] = _EXPORTTRACESERVICERESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CurrentLibraryConfig = _reflection.GeneratedProtocolMessageType(
...
UpdatedLibraryConfig = _reflection.GeneratedProtocolMessageType(
