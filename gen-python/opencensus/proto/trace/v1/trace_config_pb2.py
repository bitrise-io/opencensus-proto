...
_TRACECONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='probability_sampler',
            full_name=
            'opencensus.proto.trace.v1.TraceConfig.probability_sampler',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='constant_sampler',
            full_name='opencensus.proto.trace.v1.TraceConfig.constant_sampler',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='rate_limiting_sampler',
            full_name=
            'opencensus.proto.trace.v1.TraceConfig.rate_limiting_sampler',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'opencensus.proto.trace.v1.TraceConfig.max_number_of_attributes',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'opencensus.proto.trace.v1.TraceConfig.max_number_of_annotations',
            index=4,
            number=5,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'opencensus.proto.trace.v1.TraceConfig.max_number_of_message_events',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'opencensus.proto.trace.v1.TraceConfig.max_number_of_links',
            index=6,
            number=7,
            type=3,
            cpp_type=2,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name='sampler',
            full_name='opencensus.proto.trace.v1.TraceConfig.sampler',
            index=0,
            containing_type=None,
            fields=[]),
    ],
...
_PROBABILITYSAMPLER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'opencensus.proto.trace.v1.ProbabilitySampler.samplingProbability',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
...
_CONSTANTSAMPLER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='decision',
            full_name='opencensus.proto.trace.v1.ConstantSampler.decision',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_RATELIMITINGSAMPLER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='qps',
            full_name='opencensus.proto.trace.v1.RateLimitingSampler.qps',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
_TRACECONFIG.fields_by_name[
    'probability_sampler'].message_type = _PROBABILITYSAMPLER
_TRACECONFIG.fields_by_name['constant_sampler'].message_type = _CONSTANTSAMPLER
_TRACECONFIG.fields_by_name[
    'rate_limiting_sampler'].message_type = _RATELIMITINGSAMPLER
_TRACECONFIG.oneofs_by_name['sampler'].fields.append(
    _TRACECONFIG.fields_by_name['probability_sampler'])
_TRACECONFIG.fields_by_name[
    'probability_sampler'].containing_oneof = _TRACECONFIG.oneofs_by_name[
        'sampler']
_TRACECONFIG.oneofs_by_name['sampler'].fields.append(
    _TRACECONFIG.fields_by_name['constant_sampler'])
_TRACECONFIG.fields_by_name[
    'constant_sampler'].containing_oneof = _TRACECONFIG.oneofs_by_name[
        'sampler']
_TRACECONFIG.oneofs_by_name['sampler'].fields.append(
    _TRACECONFIG.fields_by_name['rate_limiting_sampler'])
_TRACECONFIG.fields_by_name[
    'rate_limiting_sampler'].containing_oneof = _TRACECONFIG.oneofs_by_name[
        'sampler']
_CONSTANTSAMPLER.fields_by_name[
    'decision'].enum_type = _CONSTANTSAMPLER_CONSTANTDECISION
...
TraceConfig = _reflection.GeneratedProtocolMessageType(
    'TraceConfig',
    (_message.Message, ),
    dict(
...
ProbabilitySampler = _reflection.GeneratedProtocolMessageType(
    'ProbabilitySampler',
    (_message.Message, ),
    dict(
...
ConstantSampler = _reflection.GeneratedProtocolMessageType(
    'ConstantSampler',
    (_message.Message, ),
    dict(
...
RateLimitingSampler = _reflection.GeneratedProtocolMessageType(
    'RateLimitingSampler',
    (_message.Message, ),
    dict(
